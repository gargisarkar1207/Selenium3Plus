...
public class NewTest3 {
	...
	public void testHDFC() {
		...
		act1.moveToElement(driver.findElement(By.xpath("//a[@href='/personal/products/investments']"))).perform();
		//act1.moveToElement(driver.findElement(By.xpath("//a[@href='/personal/products/demat/demat-account']"))).click().perform();
		act1.moveToElement(driver.findElement(By.xpath("//a[@href='/personal/products/investments/national-pension-system']"))).click().perform();
				
		Assert.assertTrue(driver.getTitle().startsWith("National"));
